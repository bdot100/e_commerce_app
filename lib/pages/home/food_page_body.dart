...
class _FoodPageBodyState extends State<FoodPageBody> {
  ...
  final double _scaleFacetor = 0.8;
  ...
  Widget _buildPageItem(int index, ProductModel popularProduct){
    ...
    if (index == _currPageValue.floor()) {
      var currScale = 1-(_currPageValue-index)*(1-_scaleFacetor);
      var currTrans = _height * (1 - currScale)/2;
      matrix = Matrix4.diagonal3Values(1, currScale, 1)..setTranslationRaw(0, currTrans, 0);
    }
    else if (index == _currPageValue.floor()+1) {
      var currScale = _scaleFacetor + (_currPageValue - index + 1) * (1 - _scaleFacetor);
      var currTrans = _height * (1 - currScale)/2;
      ...
      var currScale = 0.8;
      matrix = Matrix4.diagonal3Values(1, currScale, 1)..setTranslationRaw(0, _height * (1 - _scaleFacetor)/2, 1);
    }
